...
save_path=${3:-qwen3-8b-base_questioner_rzero}
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python3 -m verl.trainer.main \
    ...
    trainer.save_checkpoint_path=${STORAGE_PATH}/8bmodels/$save_path \
...
echo "merging model"
python scripts/model_merger.py --local_dir ${STORAGE_PATH}/8bmodels/$save_path/global_step_20/actor
