...
def main(args):
    ...
    for i in range(args.num_samples):
        ...
        chat = [
            {
                "role": "user",
                "content": f"Please create a new problem based on: <question>{ref_question}</question>. Please reason step by step inside <think>...</think> and output only the final problem inside <question>...</question>."
            }
        ]
